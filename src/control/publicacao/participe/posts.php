...
$pub = new Publicacao();
$tpl->GRUPO = $pub->get_pasta_grupo($pub::ID_GRUPO_PARTICIPE); 
$tpl->LABEL_TITULO = $pub->get_titulo_grupo($pub::ID_GRUPO_PARTICIPE);
$tpl->LABEL_ICONE = $pub->get_Icone_grupo($pub::ID_GRUPO_PARTICIPE);
$tpl->show();